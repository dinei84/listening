...
# chamando pipeline() (G2P real), o Kokoro já divide texto longo sozinho respeitando o
# limite de fonemas e fronteiras de frase — este valor volta a ser só sobre nº de
# chamadas ao Speaker por capítulo e tamanho prático de cada AudioChunk pra playback,
# a razão original da OS-008.
